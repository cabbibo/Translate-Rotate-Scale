  ...
  function ObjectControls( eye , controller , params ){
    ...
    var _size           = params.size           || 10;
    var _pinchStrength  = params.pinchStrength  || .5;
    var _centerPoint    = params.centerPoint    || new THREE.Vector3();

    var _oCenterPoint   = _centerPoint.clone();
    
    var _updateCenterPoint = true;

    // If we provide a center point, use that
    if( params.centerPoint ){
      _updateCenterPoint = false;
    }
    ...
    return{
      ...
      */
      ...
      setCenterPoint : function( position ){
      ...
      unsetCenterPoint : function(){

        _centerPoint = new THREE.Vector3();
        _updateCenterPoint = true;
      ...
      */
      ...
      update : function(){
        ...
        if( _frame.hands[0] && _oFrame.hands[0] ){
          ...
          //console.log( _centerPoint );
          if( _updateCenterPoint ){

            this.updateCenterPoint( _frame.hands[0].palmPosition );

          }else{

            //console.log( 'asdasggg');
      ...
      */
      ...
      checkForIntersections : function(){
      ...
      checkForSelection : function( hand , oHand ){
        ...
        if( _intersected ){
          ...
          if( hand.pinchStrength > _pinchStrength && oHand.pinchStrength <= _pinchStrength ){
